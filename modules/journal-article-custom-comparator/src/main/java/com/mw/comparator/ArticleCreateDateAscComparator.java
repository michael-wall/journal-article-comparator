...
public class ArticleCreateDateAscComparator extends OrderByComparator<JournalArticle> {
    ...
    public ArticleCreateDateAscComparator() {
        this(true); // or false, depending on your desired default
    }

    // Optional constructor for flexibility
    public ArticleCreateDateAscComparator(boolean ascending) {
